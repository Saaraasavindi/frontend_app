                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            " \LKR${(widget.mObj.totalPrice ?? 0).toStringAsFixed(2)}",
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "+ \LKR${(widget.mObj.deliverPrice ?? 0).toStringAsFixed(2)}",
                            textAlign: TextAlign.right,
                            style: TextStyle(
                                color: TColor.primaryText,
                                fontSize: 18,
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "- \LKR${(widget.mObj.discountPrice ?? 0).toStringAsFixed(2)}",
                            textAlign: TextAlign.right,
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "\LKR${(widget.mObj.userPayPrice ?? 0).toStringAsFixed(2)}",
                            textAlign: TextAlign.right,
                            style: TextStyle(
                                color: TColor.primaryText,
                                fontSize: 22,
